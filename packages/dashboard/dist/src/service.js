...
const dashboardTemplatePath = new URL("./dashboard.template", import.meta.url).pathname;
...
const server = Deno.serve({
    ...
    handler: async (req)=>{
        ...
        const rendered = renderToString(/*#__PURE__*/ React.createElement(Dashboard, null));
